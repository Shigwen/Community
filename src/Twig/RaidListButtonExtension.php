...
class RaidListButtonExtension extends AbstractExtension
{
    ...
    public function getArrayButton($nbrOfPages, $currentPage)
    {
        ...
        // Generates an array of all buttons not sorted
        ...
        // If there is less than 9 page, we do not paginate
        if ($nbrOfPages < 8) {
            return $buttons;
        }
        ...
        // Show the 5 middle buttons (2 before current, the current, 2 after current) and truncates the start and end buttons (except THE first and THE last)
        } else {
